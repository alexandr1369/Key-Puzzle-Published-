...
public class Player : MonoBehaviour
{
    ...
    {
        return SelectedLock && targetLock.GetLockHole(null) && SelectedLock.GetSelectedKey().colorType == targetLock.colorType && targetLock.LastLockHoleKeyColorTypeEqualsLockColorType();
    }
}
